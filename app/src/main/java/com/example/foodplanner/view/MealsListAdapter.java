...
public class MealsListAdapter extends RecyclerView.Adapter<MealsListAdapter.MyViewHolder> {
    ...
    @NonNull
    @Override
    public MealsListAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.meal_filtering, parent, false);
        return new MealsListAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MealsListAdapter.MyViewHolder holder, int position) {
